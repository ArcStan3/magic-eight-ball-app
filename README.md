...
In this app you will create a magic eight ball application,

The purpose of the application is to Ask the User to Type in a question into a an input box. Then click a button, when the button
is clicked, you will use a random function
...
The random function will take 0 and the length of your answers as the min and max.

Then display the answer - you can have some fun and use the

https://daneden.github.io/animate.css/

---

Here is a React Component Example that asks a user what there name is
and says hello name. You can use this as a working example.
...
class App extends React.Component {
  ...
  render () {
    return (
      <div>
        <header>
          <h1>What is your Name App?</h1>
        </header>
        <main>
          <form onSubmit={this.handleSubmit}>
            <div className="ma1 pa4 ba br2">
               <label>What is your name?</label>
               <input
                 value={this.state.name}
                 onChange={this.handleChange}
                 className="db w-100 mt2" type="text" />
            </div>
            <div className="cf">
              <button className="ma1 pa2 bn br3 bg-blue white fr">Submit</button>
            </div>
          </form>
          <hr />
          {this.state.hello
...
http://codepen.io/twilson63/pen/OpMZeV?editors=0010
